            ...
            <div className="section-content">
              ...
              {currentSection.id === 'routes' && (
                <div className="routes-grid">
                  {routesData.categories.map((category: any, idx: number) => (
                    <div key={idx} className="route-category">
                      <h3>{category.name}</h3>
                      <div className="routes-list">
                        {category.routes.map((route: any, ridx: number) => (
              ...
              {currentSection.id === 'markdown-docs' && (
                <div className="docs-grid">
                  {docsFiles.categories.map((category: any, idx: number) => (
                    <div key={idx} className="docs-category">
                      <h3>{category.name}</h3>
                      <div className="docs-list">
                        {category.files.map((file: any, fidx: number) => (
                          <a
                            key={fidx}
