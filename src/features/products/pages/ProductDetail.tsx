...
const ProductDetail = () => {
  ...
  const product = mockProducts.find((p: any) => p.id === Number(id));
  const relatedProducts =
    product?.relatedProductIds
      .map((relId: any) => mockProducts.find((p: any) => p.id === relId))
      .filter(Boolean) || [];
  ...
  const calculateDiscount = () => {
    ...
    const coupon = product.coupons.find((c: any) => c.code === appliedCoupon);
    if (!coupon) return 0;
          ...
          <div className="product-info">
            ...
            <div className="coupons-section">
              ...
              <div className="coupons-list">
                {product.coupons.map((coupon: any) => (
                  <div
                    key={coupon.code}
