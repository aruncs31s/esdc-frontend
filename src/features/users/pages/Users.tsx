        ...
        <div className="row mb-4">
          <div className="col-12">
            <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
              <div>
                <h1 className="display-4 mb-2" style={{ color: 'var(--text)' }}>
                  Community Members
                </h1>
        ...
        {filteredUsers.length === 0 ? (
          ...
          <div className={viewMode === 'grid' ? 'users-grid' : 'users-list'}>
            {filteredUsers.map((user) => (
              ...
              >
                <ProfileCard user={user} onEdit={() => {}} showStats={true} />
              </div>
            ))}
          </div>
        )}
              ...
              <div className="about-card">
                ...
                <div className="row text-center g-4">
                  <div className="col-md-3 col-6">
                    <div
                      className="p-3"
                      style={{ background: 'var(--surface0)', borderRadius: '12px' }}
                    >
                      <h2 className="mb-1" style={{ color: 'var(--blue)' }}>
                        {users.length}
                      </h2>
                      <p className="mb-0" style={{ color: 'var(--subtext0)', fontSize: '0.9rem' }}>
                        Total Members
                      </p>
                    </div>
                  </div>
