...
const TetrisGame = () => {
  ...
  const [highScore, setHighScore] = useState(
    parseInt(localStorage.getItem('tetrisHighScore') || '0') || 0
  );
  ...
  const checkCollision = useCallback(
    (piece: Piece, pos: Position, newBoard = board) => {
    ...
    <div className="games-page">
      <div className="games-container">
        ...
        <div className="game-instructions">
          ...
          <ul>
            <li>
              Use <strong>Arrow Left/Right</strong> to move pieces
            </li>
            <li>
              Use <strong>Arrow Up</strong> to rotate pieces
            </li>
            <li>
              Use <strong>Arrow Down</strong> to move faster
            </li>
            <li>
              Press <strong>Space</strong> to drop instantly
            </li>
