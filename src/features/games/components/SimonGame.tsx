...
const SimonGame = () => {
  ...
  const [highScore, setHighScore] = useState(
    parseInt(localStorage.getItem('simonHighScore') || '0') || 0
  );
      ...
      <div className="games-container">
        ...
        <div className="game-board-container">
          <div className="simon-board">
            <div className="simon-grid">
              {COLORS.map((color, index) => (
                <button
                  ...
                  style={{
                    backgroundColor: activeButton === index ? color.color : `${color.color}80`,
                  }}
            ...
            <div className="simon-center">
              ...
              {isShowingSequence && <div className="simon-status">Watch...</div>}
        ...
        <div className="game-instructions">
          ...
          <ul>
            ...
            <li>
              <strong>Click</strong> the buttons in the same order
            </li>
