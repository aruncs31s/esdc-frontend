...
function ProjectBuilding({ position, text, link, color, icon }) {
...
function Scene({ vehiclePos, vehicleRot, onPortalEnter, onlineUsers }) {
  const buildings = [
