...
interface ProjectsTableProps {
  projects: ProjectDataForAdmin[];
  onDelete: (projectId: number) => void;
}

// Projects Table Component
const ProjectsTable = ({ projects, onDelete }: ProjectsTableProps) => {
  console.log('ProjectsTable received projects:', projects, 'isArray:', Array.isArray(projects));
              ...
              >
                ...
                <td style={{
                  ...
                  <span style={{
                    ...
                    <FaCalendarAlt style={{ color: 'var(--blue)' }} /> {new Date(project.created_at).toLocaleDateString('en-US', {
                      month: 'short',
                      day: 'numeric',
                      year: 'numeric'
                    })}
